define({
    appInit: function(params) {
        ...
        kony.mvc.registry.add("frmFirst", "frmFirst", "frmFirstController");
        kony.mvc.registry.add("frmSecond", "frmSecond", "frmSecondController");
        setAppBehaviors();
    },
    postAppInitCallBack: function(eventObj) {},
    appmenuseq: function() {
        new kony.mvc.Navigation("frmFirst").navigate();
    }
});